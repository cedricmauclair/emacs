; Time-stamp: <2011-02-18 08:45:25 cmauclai>
...
(custom-set-faces
 ...
 '(default (
   ...
   (((type x) (class color) (min-colors 88) (background dark)) (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 80 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))
   (((type x) (class color) (min-colors 88) (background light)) (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 80 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
 '(bold    (
